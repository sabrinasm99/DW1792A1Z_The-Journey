...
function NewJourneyContent() {
      ...
      <div className="mt-12">
        ...
        <div className="px-10">
          ...
          <div className="px-10 mt-10">
            ...
            />
            <div className='mt-5 bg-white rounded border' style={{borderColor: '#A3A3A3'}}>
                <div className='flex border-b' style={{borderColor: '#A3A3A3'}}>
    ...
    <button onClick={() => {
        ...
        axios.post('http://localhost:5000/api/v1/journey', {
            title: title,
            userId: localStorage.getItem('userId'),
            description: content
